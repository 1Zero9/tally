  ...
  return (
    <LegalPageLayout title="Technical overview" lastUpdated={`v${APP_VERSION}`}>
      ...
      <ul>
        ...
        <li><strong><code>src/components/</code></strong> — one component per feature area (e.g. AccountsSection, StatementImportModal, StatementsSection, MoneyMap, ProgressSection, AssistantBox, OptimizationInsights, AdminSection), plus shared modals and chrome (Navbar, PrivacyBlurOverlay, HelpGuideModal, ChangelogModal).</li>
