...
export const HELP_GUIDE_SECTIONS: HelpGuideSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Money coming in shows different buttons: "Link to income" ties it to one of your recorded income sources at its real amount and date — this is how a fluctuating salary reconciles against what you\'ve set up, and marks that income "Received" automatically. Use "Log as transfer" instead for a one-off credit that isn\'t tracked income, like a refund or a gift.',
