...
export const HELP_GUIDE_SECTIONS: HelpGuideSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Big one-off costs like a mortgage, loan repayment or large purchase have their own "Mortgage, Loans & Big Purchases" category, kept separate from everyday bills. The built-in set also covers Transport & Motoring (fuel, tolls, parking, servicing), Health & Medical, and Eating Out & Takeaway — check the list before making a new one.',
  ...
  },
  {
    ...
    body: [
      ...
      'Savings: every Savings, Credit Union or Investment account you\'ve added shows here with its balance, its share of your total savings, and a combined total. State Savings, shares and the like fit under an Investment-type account.',
